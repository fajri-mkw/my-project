        ...
        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
          ...
          <div className="bg-indigo-50/40 border border-indigo-100 rounded-2xl p-6">
            ...
            <p className="text-xs text-indigo-600/70 mb-4 ml-8">
              ✅ Folder <span className="font-semibold">PRODUKSI</span> &amp; <span className="font-semibold">PASCA PRODUKSI</span> sudah tercentang otomatis. Akses <span className="font-semibold">Download/Upload</span> terisi otomatis sesuai tahapan kerja: T1 (UL) · T2 PRODUKSI (DL) · T2 PASCA PRODUKSI (UL) · T3 (DL+UL) · T4–T5 (DL). Manager tetap dapat menyesuaikan manual.
            </p>
