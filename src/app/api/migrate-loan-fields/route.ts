...
export async function GET() {
  ...
  const columns = [
    { name: 'loanGroupId', sql: `ALTER TABLE "inventory_loans" ADD COLUMN "loanGroupId" TEXT` },
    { name: 'peminjamUnit', sql: `ALTER TABLE "inventory_loans" ADD COLUMN "peminjamUnit" TEXT` },
    { name: 'peminjamPhone', sql: `ALTER TABLE "inventory_loans" ADD COLUMN "peminjamPhone" TEXT` },
  ]
  try {
