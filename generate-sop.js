...
function buildContent() {
  ...
  content.push(makeTable(
    ...
    [
      ...
      ["6", "Editor (Media)", "Tahap 2 (Pasca Produksi)", "Download & Upload"],
      ["7", "Editor (Web & Sosmed)", "Tahap 2 (Pasca Produksi)", "Download & Upload"],
      ["8", "Streaming Operator", "Tahap 2 (Pasca Produksi)", "Tempel Link Streaming"],
      ["9", "Podcast Operator", "Tahap 2 (Pasca Produksi)", "Tempel Link YouTube"],
      ["10", "Reviewer", "Tahap 3 (Review)", "Review Konten"],
      ["11", "Publisher Web", "Tahap 4 (Publikasi)", "Download & Tambah Link"],
      ["12", "Publisher Social Media", "Tahap 4 (Publikasi)", "Download & Tambah Link"],
      ["13", "Super Admin", "Semua Tahapan", "Pengelolaan Sistem"],
    ]
  ));
