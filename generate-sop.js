...
function buildContent() {
  ...
  content.push(makeTable(
    ...
    [
      ...
      ["4", "Photographer & Audio", "Tahap 1 (Produksi)", "Upload File"],
      ["5", "Videographer & Audio", "Tahap 1 (Produksi)", "Upload File"],
      ["6", "Graphic Designer", "Tahap 1 (Produksi)", "Upload File"],
      ["7", "Editor (Media)", "Tahap 2 (Pasca Produksi)", "Download & Upload"],
      ["8", "Editor (Web & Sosmed)", "Tahap 2 (Pasca Produksi)", "Download & Upload"],
      ...
      ["11", "Reviewer", "Tahap 3 (Review)", "Review Konten"],
      ["12", "Publisher Web", "Tahap 4 (Publikasi)", "Download & Tambah Link"],
      ["13", "Publisher Social Media", "Tahap 4 (Publikasi)", "Download & Tambah Link"],
      ["14", "Super Admin", "Semua Tahapan", "Pengelolaan Sistem"],
    ]
  ));
